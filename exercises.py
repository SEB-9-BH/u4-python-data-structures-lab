...
def manage_students():
    # your code here
    students = ["Alice", "Bob", "Charlie"]   # create list
...
def combine_foods():
    # your code here
    foods = ("Pizza", "Burger", "Pasta")     # tuple of foods (same length as students list above)
    meal = ""                                # empty string
    for food in foods:
        meal += food + " "                   # concatenate with a space
    return meal.strip()       
# Call the function and print the result
...
def slice_foods():
    ...
    last_two_foods = foods[-2:]              # slice last two
