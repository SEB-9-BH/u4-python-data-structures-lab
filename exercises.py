...
def combine_foods():
    ...
    for food in foods:
         # Append each food to the meal string, separated by spaces
        meal += food + " "
    
    # Strip removes the last extra space
    return meal.strip()
...
def slice_foods():
    ...
    # slicing to get the last two items
    # Negative index: -2 means "second from last", : means up to the end
...
def hometown_info():
    ...
    home_town_message = (
        f"I was born in {home_town['city']}, {home_town['state']} - "
...
def list_home_town_items():
    ...
    # Empty list to collect formatted strings
    home_town_items = []
