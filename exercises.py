...
foods=('pizza','burger','twister')

def combine_foods():
    # your code here
    meal = ''  # start with empty string
    for food in foods:
        meal += f"{food} "  # concatenate each food
    return meal
# Call the function and print the result
...
def slice_foods():
    # your code here
    last2indx=len(foods)-2
    last_two_foods = foods[last2indx:]
...
home_town={'city':'sitra','state':'Southern Governorate','population':'3888'}
def hometown_info():
    # your code here
    home_town_message=f"I was born in {home_town['city']}, {home_town['population']} - population of {home_town['state']}"
